  ...
  return (
    <div className="min-h-screen w-full bg-white flex items-center justify-center">
      ...
      <div className="absolute inset-0 opacity-20">
        ...
        <div className="absolute inset-0 bg-gradient-to-b from-transparent via-white/5 to-transparent transform -rotate-12"></div>
      </div>
      ...
      <div className="relative z-10 text-center px-4 sm:px-6 lg:px-8 max-w-4xl mx-auto">
        <h1 className="text-4xl sm:text-6xl font-light text-gray-800 mb-4">This Page is Under Construction</h1>

        <p className="text-lg text-gray-500">We will be back soon.</p>
      </div>

      <div className="absolute bottom-0 left-0 right-0">
        <svg viewBox="0 0 1200 120" preserveAspectRatio="none" className="w-full h-16 sm:h-20 lg:h-24">
          <path
